...
export default function TranslationDetailPage() {
  ...
  const {
    ...
    isLoading,
    error,
  } = useGetTranslation(parseInt(id as string));
      ...
      <div className="container mx-auto p-4">
        <Card className="w-full border-red-200 bg-red-50 p-6">
          ...
          <p className="text-red-600">
            Failed to load translation details. Please try again later.
          </p>
        </Card>
      </div>
    );
        ...
        <CardContent>
          <Tabs defaultValue="translation" className="w-full">
            ...
            <TabsContent value="context" className="mt-4">
              <Card>
                <CardContent className="pt-6">
                  <p>{translation.context || "No context provided"}</p>
                </CardContent>
              </Card>
            </TabsContent>
                ...
                <CardContent className="pt-6">
                  <dl className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    ...
                    <div>
                      ...
                      <dd>{translation.created_by}</dd>
                    </div>
                    <div>
                      <dt className="font-semibold text-muted-foreground">
                        Last Updated By
                      </dt>
                      <dd>{translation.updated_by}</dd>
                    </div>
                  </dl>
                </CardContent>
              </Card>
